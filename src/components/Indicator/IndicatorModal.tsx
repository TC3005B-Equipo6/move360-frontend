...
import {IndicatorColorPicker, colorOptions} from "./IndicatorColor";
import { IndicatorTypeToggle } from "./IndicatorType";
...
export const IndicatorModal = ({
  ...
  const [isPositive, setIsPositive] =
    useState(true);

  const [selectedColor, setSelectedColor] =
    useState<keyof typeof colorOptions>(
      "green"
    );
